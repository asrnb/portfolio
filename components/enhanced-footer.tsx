...
import { Github, Linkedin, Mail, Send, ArrowUp, MapPin, Phone, Calendar, CheckCircle } from "lucide-react"
import { z } from "zod"
      ...
      <div className="container mx-auto px-4 py-12">
            ...
            >
              ...
              <div className="flex gap-3">
                <SocialButton
                  ...
                  url="https://github.com/asrnb"
                  label="GitHub"
                />
                <SocialButton
                  icon={<Linkedin className="h-5 w-5" />}
                  url="https://ph.linkedin.com/in/aprilsuarnaba"
                  label="LinkedIn"
                />
                <SocialButton
                  icon={<Mail className="h-5 w-5" />}
                  url="mailto:aprilsuarnaba5@gmail.com"
                  label="Email"
                />
              </div>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-muted-foreground">
                  ...
                  <span>aprilsuarnaba5@gmail.com</span>
                </li>
                <li className="flex items-center gap-3 text-muted-foreground">
                  <Phone className="h-4 w-4 text-primary" />
                  <span>(0950) 743-4305</span>
                </li>
                <li className="flex items-center gap-3 text-muted-foreground">
        ...
        <div className="border-t pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm text-muted-foreground mb-4 md:mb-0">
            © {currentYear} April Suarnaba. All rights reserved.
          </div>
